...
import {DescriptionIcon, AnalyticsIcon, CommentIcon } from '../../utils/Icons';
                ...
                <>
                    ...
                    <div className="showContent">
                        <div className="content">
                                    ...
                                    <div className="reviews">
                                        ...
                                        <div className="review">
                                            <div className="review-header">
                                                <span>資訊管理系 三年級</span>
                                                <span className="review-date">2024-03-01</span>
                                            </div>
                                            <p>探討人生中所面對的生死、命運、現實與理想、順境與逆境、自我實現。人生主軸以及自我價值性的問題。並藉由電影、國內外社會實際、相關主題訪談及分享作為輔助，以深度詮釋課程意義。</p>
                                        </div>
                                        {/* 第二則評論 */}
                                        <div className="review">
                                            <div className="review-header">
                                                <span>資訊管理系 三年級</span>
                                                <span className="review-date">2024-01-19</span>
                                            </div>
                                            <p>探討人生中所面對的生死、命運、現實與理想、順境與逆境、自我實現。人生主軸以及自我價值性的問題。並藉由電影、國內外社會實際、相關主題訪談及分享作為輔助，以深度詮釋課程意義。</p>
                                        </div>
                                        {/* 第三則評論 */}
                                        <div className="review">
                                            <div className="review-header">
                                                <span>資訊管理系 三年級</span>
                                                <span className="review-date">2024-01-18</span>
                                            </div>
                                            <p>探討人生中所面對的生死、命運、現實與理想、順境與逆境、自我實現。人生主軸以及自我價值性的問題。並藉由電影、國內外社會實際、相關主題訪談及分享作為輔助，以深度詮釋課程意義。</p>
                                        </div>
                                    </div>
                            ...
                            <button onClick={closeContent}>關閉</button>
                        </div>
                    </div>
                </>
            )}
